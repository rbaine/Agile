...
var dbCollection = "iterations";
    ...
    return {
        get: function (db, id, callback) {
                ...
                var where = {_id: o_id};
                var d = new Date();
                console.log('iteration.get ' + d.format(logDateFormat));
        ...
        post: function (db, data, callback) {
            var collection = db.collection(dbCollection);
            var d = new Date();
            console.log('iteration.post ' + d.format(logDateFormat));
        ...
        delete: function (db, id, callback) {
            ...
            var collection = db.collection(dbCollection);
            var d = new Date();
            console.log('iteration.delete ' + d.format(logDateFormat));
        ...
        put: function (db, data, callback) {
            ...
            var upd = {'$set': data};
            var d = new Date();
            console.log('iteration.put ' + d.format(logDateFormat));
        ...
        list: function (db, projectid, callback) {
            ...
            var d = new Date();
            console.log('iteration.list ' + d.format(logDateFormat));
            var collection = db.collection(dbCollection);
...
//{"projectId" : "552473f41427a924142847b9"}